...
def main():
    ...
    time_series.to_csv("Data/TimeSeriesNotAggregatedUpto0.csv", index=False)
    ...
    for p in patient_ids:
        ...
        heart_rate_series = patient_slice['CentralvenousO2Saturation']
        if heart_rate_series.isnull().values.all():
